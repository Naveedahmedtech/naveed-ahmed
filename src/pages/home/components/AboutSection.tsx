...
const AboutSection = () => {
    return (
        <section id="about" className="py-16 bg-background text-text">
            <div className="container mx-auto px-4 md:px-20 flex flex-col lg:flex-row items-center justify-between gap-10">
                ...
                <div className="hero-image w-full lg:w-1/2 flex justify-center lg:justify-end">
                    <img src={hero} alt="Naveed Ahmed" className="rounded-lg shadow-xl max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg" />
                </div>
            </div>
        </section>
    );
