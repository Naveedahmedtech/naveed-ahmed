...
const ProjectCard = ({ project }: any) => {
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-black bg-opacity-70 opacity-0 transition-opacity duration-500 hover:opacity-100 flex items-center justify-center p-6">
                <div>
